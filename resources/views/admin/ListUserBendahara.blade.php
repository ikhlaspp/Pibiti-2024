...
@section('section')
    <div
        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                <form action="{{ route('bendahara.view') }}" method="GET"
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <form action="{{ route('bendahara.export') }}" method="get">
                        @csrf
                        <button type="submit">
                            <span
                            ...
                            @foreach ($user as $item)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td
                                        ...
                                        @if ($item->role == 0)
                                            <form action="{{ route('bendahara.verification', $item->id) }}"
                                                method="post"
                                        ...
                                        @endif
                                        @if ($item->role == 2)
                                            <form action="{{ route('bendahara.unverification', $item->id) }}"
                                                method="post"
