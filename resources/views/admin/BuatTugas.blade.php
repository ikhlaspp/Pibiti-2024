...
@section('section')
    ...
    <form action="{{ route('tasks.create') }}" method="POST" class="bg-white shadow-md rounded-lg" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-tambah-materi">
            ...
            <div class="bg-white p-5 shadow-sm rounded-lg w-full">
                <label for="URL" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">File</label>
                <input type="file" id="url" name="urltugas" accept="application/pdf"
                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
