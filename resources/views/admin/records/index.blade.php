    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                      ...
                      <li>
                        <div class="flex items-center">
                          ...
                          <a href="#" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Video Record</a>
                        </div>
                      </li>
                      <li>
                        <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">List Video Record</h1>
            </div>
            <div class="sm:flex">
                        ...
                        <div class="p-6 space-y-6">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-12">
                                        ...
                                        <input type="text" name="urlvideo" id="link"
                            ...
                            @foreach ($post as $item)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">
                                        <a href="{{ $item->urlvideo }}">{{ $item->urlvideo }}</a>
                                    </td>
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white flex">
                                        <div class="mr-3">
                                            <form action="{{ route('records.delete', ['id' => $item->id]) }}" method = "post" onclick="return confirm('Apakah Anda yakin ingin menghapus video record ini?')">
                                                @csrf
                                                @method("DELETE")
                                    ...
                                    <div
                                        ...
                                        <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <!-- Modal body -->
                                                <form method="post" action="{{ route('records.update', ['id' => $item->id]) }}">
                                                    <div class="p-6 space-y-6">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="grid grid-cols-6 gap-6">
                                                                <div class="col-span-12">
                                                                    ...
                                                                    <input type="text" name="urlvideo" id="link"
                                                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                        placeholder="Masukkan link..." value="{{ $item->urlvideo }}" required>
                                                                </div>
                                                                <div class="col-span-12">
                                                                    <label for="date"
                                                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal</label>
                                                                    <input type="date" name="hari" id="date"
                                                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                                        placeholder="Masukkan link..." value="{{ $item->hari }}" required>
                                                                </div>
                                                            </div>
                                                    </div>
                                                    <!-- Modal footer -->
