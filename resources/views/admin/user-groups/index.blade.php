    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="mb-4">
                    ...
                    <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                      ...
                      <li>
                        <div class="flex items-center">
                          ...
                          <a href="#" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Link Grub WA</a>
                        </div>
                      </li>
                      <li>
                        <div class="flex items-center">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">List Link Grub WA</h1>
            </div>
            <div class="sm:flex">
                    ...
                    <form method="post" action="">
                        <div class="p-6 space-y-6">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-12">
                                        <label for="user_id"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Peserta</label>
                                        {{-- <input type="number" name="link" id="link"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="Masukkan link..." required> --}}
                                            <select name="user_id" id="user_id">
                                                <option value="1">Peserta 1</option>
                                            </select>
                                    </div>
                                </div>
                        </div>
                            ...
                            {{-- @foreach ($tugas as $item)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white flex">
                                        <div class="mr-3">
                                            <form action="{{ route('records.delete', ['id' => $item->id]) }}" method = "post" onclick="return confirm('Apakah Anda yakin ingin menghapus tugas ini?')">
                                                @csrf
                                                @method("DELETE")
